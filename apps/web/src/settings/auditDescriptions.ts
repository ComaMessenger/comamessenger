...
export const auditActions = [
  ...
  "agent.pause",
  "agent.resume",
  "agent.rollback.prepare",
  "agent.key.create",
  "agent.key.revoke",
  "agent.settings.update",
  "agent.provider_credential.update",
  "agent.llm_connection.create",
  "agent.llm_connection.update",
  "agent.llm_connection.delete",
  "agent.llm_connection.test",
...
const ru: Record<(typeof auditActions)[number], string> = {
  ...
  "agent.publish": "опубликовал(а) новую версию агента {{target}}",
  "agent.pause": "поставил(а) агента {{target}} на паузу",
  "agent.resume": "возобновил(а) работу агента {{target}}",
  "agent.rollback.prepare":
    "подготовил(а) черновик агента {{target}} из прежней версии",
  ...
  "agent.llm_connection.create": "добавил(а) подключение LLM",
  "agent.llm_connection.update": "изменил(а) подключение LLM",
  "agent.llm_connection.delete": "удалил(а) подключение LLM",
  "agent.llm_connection.test": "проверил(а) подключение LLM",
...
const en: Record<(typeof auditActions)[number], string> = {
  ...
  "agent.publish": "published a new version of agent {{target}}",
  "agent.pause": "paused agent {{target}}",
  "agent.resume": "resumed agent {{target}}",
  "agent.rollback.prepare":
    "prepared an agent {{target}} draft from an earlier version",
  ...
  "agent.llm_connection.create": "added an LLM connection",
  "agent.llm_connection.update": "updated an LLM connection",
  "agent.llm_connection.delete": "removed an LLM connection",
  "agent.llm_connection.test": "tested an LLM connection",
